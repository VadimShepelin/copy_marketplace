...
import com.spring.mail.repository.ProductRepository;
import com.spring.mail.service.impl.ProductServiceImpl;
...
import static com.spring.mail.util.ProductTestUtil.*;
...
class ProductServiceImplTest {
    ...
    void getProductById_shouldReturnProduct() {
        com.spring.mail.model.Product product = createProduct();
    ...
    void saveProduct_shouldSaveProduct() {
        ...
        doReturn(product).when(conversionService).convert(productDto, com.spring.mail.model.Product.class);
